It is some time desirable to model parts while building the assembly. This tutorial shows two approaches of doing this. This tutorial shows two approaches of doing this.
