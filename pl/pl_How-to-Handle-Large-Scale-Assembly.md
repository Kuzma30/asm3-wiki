Ten poradnik prezentuje niektóre funkcje oferowane przez środowisko `Złożenie 3` do pracy ze skomplikowanymi złożeniami. The sample assembly used in this tutorial is not that complex by itself, but by following the steps illustrated here, smaller assembly can be easily scaled up to build much larger and complex ones.
