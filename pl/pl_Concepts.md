...
Na początku warto sięgnąć do [tego poradnika](https://web.archive.org/web/20191130140733/https://www.freecadweb.org/wiki/Assembly_Basic_Tutorial), aby zapoznać się z pojęciem _lokalnych układów współrzędnych_. Poradnik stworzono dla pierwotnej, niedokończonej wersji środowiska pracy Złożenie, ale daje całkiem dobry pogląd na to, co spotkamy również w środowisku Złożenie 3. Kontenery `Część (Part)` i `Produkt (Product)` z poradnika odpowiadają kontenerowi `Złożenie` ze Złożenia 3, z ktorego naturalnie można korzystać w podobny sposób jak z _Części_, wstawiając go do innych złożeń. Nie zgadzam się z poradnikiem w jednej sprawie. Posługiwanie się _globalnym układem współrzędnych_ wciąż jest przydatne i konieczne, by móc korzystać równocześnie z obiektów pochodzących z innych, nierozwijanych już (i być może nie wspierających lokalnych układów współrzędnych) środowisk pracy. Zdefiniujmy zatem _globalny układ współrzędnych_ jako trójwymiarowy układ współrzędnych, innymi słowy lokalizację, w której faktycznie znajduje się obiekt w widoku 3D, a także jego współrzędne wyświetlane na pasku stanu, gdy przesuwasz myszkę nad obiektem.
